...
public class myDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("create table "+DB_NAME+" ( "+USER_ID+" integer primary key autoincrement , "+USER_NAME+" text ,  "+USER_EMAIL+" text not null unique , "+USER_PHONE+" text unique , "+USER_PASS+" text unique )  ");
    }
